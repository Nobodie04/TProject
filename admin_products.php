...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, stok, image) VALUES('$name', '$price', '$stok', '$image')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `products` SET name = '$update_name', price = '$update_price', stok = '$update_stok' WHERE id = '$update_p_id'") or die('query failed');
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="name"><?php echo $fetch_products['name']; ?> (<?php echo $fetch_products['stok']; ?>)</div>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" name="update_stok" value="<?php echo $fetch_update['stok']; ?>" min="0" class="box" required placeholder="Masukkan stok">
